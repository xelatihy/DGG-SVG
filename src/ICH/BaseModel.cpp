...
void CBaseModel::ReadObjFile(const string& filename)
{
  ...
  // m_Verts.swap(vector<CPoint3D>(m_Verts)); // TODO: what does this do?
  // m_Faces.swap(vector<CFace>(m_Faces)); // TODO: what does this do?
  m_Verts.swap(m_Verts); // TODO: what does this do?
  m_Faces.swap(m_Faces); // TODO: what does this do?
...
void CBaseModel::ReadOffFile(const string& filename)
{
  ...
  // m_Verts.swap(vector<CPoint3D>(m_Verts)); // TODO(fabio) what does this do?
  ...
  in.close();
  //m_Faces.swap(vector<CFace>(m_Faces)); // TODO(fabio) what does this do?
}
